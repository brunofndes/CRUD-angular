 ...
 */
export class ProductRead2DataSource extends DataSource<Products> {
  data: Products[] = EXAMPLE_DATA;
   ...
   */
  private getPagedData(data: Products[]) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: Products[]) {
